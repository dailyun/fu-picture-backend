...
import com.dali.fupicturebackend.manager.upload.FilePictureUpload;
import com.dali.fupicturebackend.manager.upload.PictureUploadTemplate;
import com.dali.fupicturebackend.manager.upload.UrlPictureUpload;
import com.dali.fupicturebackend.model.dto.file.UploadPictureResult;
...
import com.dali.fupicturebackend.model.vo.UserVO;
...
//            }
    ...
    public Page<PictureVO> getPictureVOPage(Page<Picture> picturePage, HttpServletRequest request) {
        ...
        log.warn("Total records count: " + picturePage.getTotal());
        log.warn("Current page records: " + picturePage.getRecords().size());
    ...
    @Override
    public void deletePictureService(long pictureId, User loginUser) {
